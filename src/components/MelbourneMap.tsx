  ...
  return (
    ...
    >
      <ellipse
        ...
        rx="163"
        ry="168"
        fill="color-mix(in srgb, var(--color-gold) 5%, transparent)"
        stroke="color-mix(in srgb, var(--color-gold) 32%, transparent)"
        strokeWidth="1.5"
        strokeDasharray="6 9"
      />
      ...
      <path
        ...
        fill="color-mix(in srgb, var(--color-blue) 26%, transparent)"
        stroke="color-mix(in srgb, var(--color-blue) 85%, transparent)"
        strokeWidth="1.8"
      ...
      <text
        ...
        y="436"
        textAnchor="middle"
        fill="color-mix(in srgb, var(--color-muted-dark) 90%, transparent)"
      ...
      <g
        fill="color-mix(in srgb, var(--color-muted-dark) 72%, transparent)"
        fontFamily="var(--font-body)"
        fontSize="12"
        fontWeight="600"
        letterSpacing="1.5"
      ...
      <circle cx="316" cy="136" r="4.5" fill="var(--color-blue-soft)" />
      <text
        x="330"
        y="133"
      ...
      <path
        ...
        fill="var(--color-gold)"
      />
      <circle cx="193" cy="82" r="7.6" fill="var(--color-ink-deep)" />
      <text
        x="193"
        y="136"
        textAnchor="middle"
